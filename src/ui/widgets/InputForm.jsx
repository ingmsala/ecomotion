  ...
  return (
    <>
      <div className='relative'>
        <input type={type} id={idName} name={idName} autoFocus={focus} placeholder=' ' autoComplete='on'
          className={
            `block rounded-t px-2.5 pb-2.5 w-11/12 mx-auto
      ...
      {
        errorField && (
          <span className='text-xs text-red-500 w-11/12 ml-5'>
            {errorField}
          </span>
        )
      }
